...
@Slf4j
@Service
public class RetryPushProducerService {
    private final MessageConverter messageConverter;
    private final AmqpTemplate amqpTemplate;

    @Autowired
    public RetryPushProducerService(@Qualifier("jsonMessageConverter") MessageConverter messageConverter, @Qualifier("retryPushRabbitTemplate") AmqpTemplate amqpTemplate) {
